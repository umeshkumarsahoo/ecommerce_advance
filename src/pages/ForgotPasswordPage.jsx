        ...
        <div className="auth-page" style={{ paddingTop: '120px', minHeight: '100vh', background: 'var(--bg-primary)' }}>
            <div className="container" style={{ maxWidth: '500px', margin: '0 auto', padding: '0 20px' }}>
                <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
                    <AnimatedText>
                        <h1 className="text-h2" style={{ marginBottom: '1rem', color: 'var(--text-primary)' }}>Reset Password</h1>
                    </AnimatedText>
                    <AnimatedText delay={0.1}>
                        <p style={{ color: 'var(--text-muted)' }}>Enter your email and a new password.</p>
                    </AnimatedText>
                </div>
